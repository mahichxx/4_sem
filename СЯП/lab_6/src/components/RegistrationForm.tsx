...
export default function RegistrationForm() {
    ...
    const { currentStep, formData, errors, isSubmitting, isSuccess } = state;
            ...
            <div className="wrap">
                <div className="card">
                    ...
                    <div className="progress-track">
                        {[1, 2, 3].map((n) => <div key={n} className="progress-seg done" />)}
                    </div>
                    <div className="success-box">
                        <div className="success-icon">✓</div>
                        <h2 className="success-title">Добро пожаловать, {formData.username}!</h2>
                        <p className="success-sub">Аккаунт создан. Данные выведены в консоль.</p>
                    </div>
                </div>
            </div>
        );
