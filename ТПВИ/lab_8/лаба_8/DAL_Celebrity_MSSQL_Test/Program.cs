// DAL_Celebrity_MSSQL_Test/Program.cs
...
internal class Program
{
    ...
    {
        string CS = @"Server=(localdb)\MSSQLLocalDB;Database=LES01;Trusted_Connection=True;TrustServerCertificate=True";
        ...
        using (var repo = Repository.Create(CS))
        {
            {
