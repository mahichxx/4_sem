// DAL_Celebrity_MSSQL/Init.cs
namespace DAL_Celebrity_MSSQL
{
    public class Init
    {
        static string connstring = @"Server=(localdb)\MSSQLLocalDB;Database=LES01;Trusted_Connection=True;TrustServerCertificate=True";
        ...
        public static void Execute(bool delete = true, bool create = true)
        {
            ...
            { //5
                ...
                Lifeevent l2 = new Lifeevent() { CelebrityId = 5, Date = new DateTime(1991, 9, 17), Description = "Выложил исходный код OS Linux (0.01)", ReqPhotoPath = null };
                context.Celebrities.Add(c);
                context.Lifeevents.Add(l1);
                context.Lifeevents.Add(l2);
            }
            ...
            { //10
                ...
                Lifeevent l2 = new Lifeevent() { CelebrityId = 10, Date = new DateTime(1987, 1, 1), Description = "Создал OS MINIX", ReqPhotoPath = null };
                context.Celebrities.Add(c);
                context.Lifeevents.Add(l1);
                context.Lifeevents.Add(l2);
            }
